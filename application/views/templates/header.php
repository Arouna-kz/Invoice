                    ...
                    <?php if($this->session->userdata('is_logged_in')): ?>
                        ...
                        <?php if($this->session->userdata('user_role') == 'admin'): ?>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu bg-dark">
                                    ...
                                    <li><a class="dropdown-item text-light" href="<?php echo base_url('admin/users'); ?>">Users</a></li>
                                    <li><a class="dropdown-item text-light" href="<?php echo base_url('admin/invoices'); ?>">Invoices</a></li>
                                    <li><a class="dropdown-item text-light" href="<?php echo base_url('admin/pools'); ?>">Pools</a></li>
                                    <li><a class="dropdown-item text-light" href="<?php echo base_url('admin/settings'); ?>">Settings</a></li>
                                </ul>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if(in_array($this->session->userdata('user_role'), ['enterprise', 'admin'])): ?>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu bg-dark">
                                    <li><a class="dropdown-item text-light" href="<?php echo base_url('enterprise'); ?>">Dashboard</a></li>
                                    <li><a class="dropdown-item text-light" href="<?php echo base_url('enterprise/invoices'); ?>">My Invoices</a></li>
                                    <li><a class="dropdown-item text-light" href="<?php echo base_url('enterprise/create_invoice'); ?>">Submit Invoice</a></li>
                                    <li><a class="dropdown-item text-light" href="<?php echo base_url('enterprise/funds'); ?>">Withdraw Funds</a></li>
                                </ul>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if(in_array($this->session->userdata('user_role'), ['investor', 'admin'])): ?>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu bg-dark">
                                    <li><a class="dropdown-item text-light" href="<?php echo base_url('investor'); ?>">Dashboard</a></li>
                                    <li><a class="dropdown-item text-light" href="<?php echo base_url('investor/marketplace'); ?>">Marketplace</a></li>
                                    <li><a class="dropdown-item text-light" href="<?php echo base_url('investor/pools'); ?>">Pools</a></li>
                                    <li><a class="dropdown-item text-light" href="<?php echo base_url('investor/portfolio'); ?>">Portfolio</a></li>
                                    <li><a class="dropdown-item text-light" href="<?php echo base_url('investor/claims'); ?>">Claims</a></li>
                                </ul>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if(in_array($this->session->userdata('user_role'), ['client', 'admin'])): ?>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu bg-dark">
                                    <li><a class="dropdown-item text-light" href="<?php echo base_url('client'); ?>">Dashboard</a></li>
                                    <li><a class="dropdown-item text-light" href="<?php echo base_url('client/invoices'); ?>">My Invoices</a></li>
                                    <li><a class="dropdown-item text-light" href="<?php echo base_url('client/payment_history'); ?>">Payment History</a></li>
                                </ul>
                            </li>
                        <?php endif; ?>
                    <?php endif; ?>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <div id="wallet-status" class="nav-link">
                            <span id="wallet-indicator" class="badge bg-secondary">
                                <i class="fas fa-wallet me-1"></i> Not Connected
                            </span>
                        </div>
                    </li>
                    ...
                    <?php if($this->session->userdata('is_logged_in') || !empty($this->session->userdata('wallet_address'))): ?>
                        ...
                        <li  class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu bg-dark">
                                <li><a class="dropdown-item text-light" href="<?php echo base_url('dashboard/profile'); ?>">Profile</a></li>
                                <li><a class="dropdown-item text-light" href="<?php echo base_url('dashboard/settings'); ?>">Settings</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item text-light" href="<?php echo base_url('auth/logout'); ?>">Logout</a></li>
                            </ul>
                        </li>
                    <?php else: ?>
                    <!-- Login/Register -->
